...
public class NetworkUtils {
    ...
    public static ItemStack readItemStack(PacketBuffer buffer) {
        try {
            ...
            MechTech.logger.catching(e);
            return ItemStack.EMPTY;
        }
    }

    public static void writeFluidStack(PacketBuffer buffer, FluidStack fluidStack) {
        if (fluidStack == null) {
    ...
    public static void writeStringSafe(PacketBuffer buffer, String string) {
        ...
        if (bytesTest.length > 32767) {
            ...
            MechTech.logger.warn("Warning! Synced string exceeds max length!");
        } else {
            bytes = bytesTest;
        }
