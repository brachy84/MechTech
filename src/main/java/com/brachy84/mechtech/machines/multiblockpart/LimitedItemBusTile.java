package com.brachy84.mechtech.machines.multiblockpart;
...
import com.brachy84.mechtech.capability.impl.LimitedItemHandlerContainer;
...
public class LimitedItemBusTile extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<ILimitedItemHandler> {
    ...
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new LimitedItemBusTile(metaTileEntityId, getTier(), itemHandler);
    }
